...
<@default title="${tag.tagName} - ${options.blog_title?default('vno')}" keywords="${options.seo_keywords?if_exists}" desc="${options.seo_desc?if_exists}" canonical="${options.blog_url?if_exists}/tags/${tag.tagUrl}">
