<section class="read-more">
    ...
    <div class="read-more-item">
        ...
        <h2 class="post-list__post-title post-title">
            <a href="${options.blog_url!}/archives/${prePost.url}" title="link to ${prePost.title}">${prePost.title}</a>
        </h2>
        <p class="excerpt">
        ...
        <div class="post-list__meta">
            ...
            <a class="btn-border-small" href="${options.blog_url!}/archives/${prePost.url}">继续阅读</a>
        </div>
    </div>
    </#if>
    <#if nextPost??>
    <div class="read-more-item">
        ...
        <h2 class="post-list__post-title post-title">
            <a href="${options.blog_url!}/archives/${nextPost.url}" title="link to ${nextPost.title}">
            ${nextPost.title!}
            </a>
        </h2>
        <p class="excerpt">
        ...
        <div class="post-list__meta">
            ...
            <a class="btn-border-small" href="${options.blog_url!}/archives/${nextPost.url}">继续阅读</a>
        </div>
    </div>
    </#if>
</section>
